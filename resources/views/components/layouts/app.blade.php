            ...
            <div class="fixed inset-0 flex">
                <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-[#174b84] px-6 pb-4">
                        <div class="-mx-6 px-6 flex h-16 shrink-0 items-center bg-white border-b border-slate-200">
                            ...
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <li>
                                            <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'bg-[#1e5c9f] text-white' : 'text-slate-200 hover:bg-[#1e5c9f] hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                                        ...
                                        <li>
                                            <a href="{{ route('jadwal-audit.index') }}" class="{{ request()->routeIs('jadwal-audit.*') ? 'bg-[#1e5c9f] text-white' : 'text-slate-200 hover:bg-[#1e5c9f] hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        ...
                                        <li>
                                            <a href="{{ route('kka.index') }}" class="{{ request()->routeIs('kka.*') ? 'bg-[#1e5c9f] text-white' : 'text-slate-200 hover:bg-[#1e5c9f] hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        ...
                                        <li>
                                            <a href="{{ route('temuan.index') }}" class="{{ request()->routeIs('temuan.*') ? 'bg-[#1e5c9f] text-white' : 'text-slate-200 hover:bg-[#1e5c9f] hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        ...
                                        <li>
                                            <a href="{{ route('laporan.index') }}" class="{{ request()->routeIs('laporan.*') ? 'bg-[#1e5c9f] text-white' : 'text-slate-200 hover:bg-[#1e5c9f] hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

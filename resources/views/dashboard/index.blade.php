<x-layouts.app>
    ...
    <div>
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <!-- Audit Berjalan -->
            <div class="relative overflow-hidden rounded-lg bg-white p-5 shadow border border-slate-100 hover:border-slate-300 transition-colors flex flex-col gap-4">
                <div class="flex items-center gap-4">
                    <div class="shrink-0 rounded-md bg-[#174b84] p-3">
                        <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                        </svg>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-slate-500 leading-tight">Audit Berjalan</p>
                ...
                <div class="border-t border-slate-100 pt-3 text-sm">
                    <a href="{{ route('jadwal-audit.index') }}" class="font-medium text-[#174b84] hover:text-[#123964]">Lihat detail</a>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden rounded-lg bg-white p-5 shadow border border-slate-100 hover:border-slate-300 transition-colors flex flex-col gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-sm font-medium text-slate-500 leading-tight">Temuan Baru</p>
                        <p class="text-2xl font-semibold text-slate-900">{{ $summary['temuan_baru'] ?? 0 }}</p>
                    </div>
                </div>
                <div class="border-t border-slate-100 pt-3 text-sm">
                    <a href="{{ route('temuan.index') }}" class="font-medium text-[#174b84] hover:text-[#123964]">Lihat temuan</a>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden rounded-lg bg-white p-5 shadow border border-slate-100 hover:border-slate-300 transition-colors flex flex-col gap-4">
                <div class="flex items-center gap-4">
                    <div class="shrink-0 rounded-md bg-[#f4b41a] p-3">
                        <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                        </svg>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-slate-500 leading-tight">KKA Menunggu Review</p>
                        <p class="text-2xl font-semibold text-slate-900">{{ $summary['kka_menunggu_review'] ?? 0 }}</p>
                    </div>
                </div>
                <div class="border-t border-slate-100 pt-3 text-sm">
                    <a href="{{ route('kka.index') }}" class="font-medium text-[#174b84] hover:text-[#123964]">Proses sekarang</a>
                </div>
            </div>

            <!-- Tindak Lanjut Diproses -->
            <div class="relative overflow-hidden rounded-lg bg-white p-5 shadow border border-slate-100 hover:border-slate-300 transition-colors flex flex-col gap-4">
                <div class="flex items-center gap-4">
                    <div class="shrink-0 rounded-md bg-emerald-500 p-3">
                        <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                        </svg>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-slate-500 leading-tight">Tindak Lanjut Diproses</p>
                        <p class="text-2xl font-semibold text-slate-900">{{ $summary['tindak_lanjut_proses'] ?? 0 }}</p>
                    </div>
                </div>
                <div class="border-t border-slate-100 pt-3 text-sm">
                    <a href="{{ route('tindak-lanjut.index') }}" class="font-medium text-[#174b84] hover:text-[#123964]">Pantau progres</a>
                </div>
            </div>
        </dl>
